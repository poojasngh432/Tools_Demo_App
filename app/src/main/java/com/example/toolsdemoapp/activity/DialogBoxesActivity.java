...
public class DialogBoxesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialogType1Btn = (Button) findViewById(R.id.dialog_slide_in);
        ...
        alertBuilderBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(DialogBoxesActivity.this);
        ...
        dialogType1Btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    dialogBox = new Dialog(DialogBoxesActivity.this, android.R.style.Theme_Material_Light_Dialog_Alert);
                } else {
                    dialogBox = new Dialog(DialogBoxesActivity.this);
                }
        ...
        progressDialogBtn.setOnClickListener(view -> {
            pd = ProgressDialog.show(DialogBoxesActivity.this, getString(R.string.process_dialog), getString(R.string.process_dialog_message), true, true);
            //    pd.dismiss();
        });
        ...
        datePickerBtn.setOnClickListener(view -> {
            ...
            DatePickerDialog datePickerDialog = new DatePickerDialog(DialogBoxesActivity.this,
                    (view1, year, monthOfYear, dayOfMonth) -> selectDateEditText.setText(dayOfMonth + "-" + (monthOfYear + 1) + "-" + year), mYear, mMonth, mDay);
        ...
        timePickerBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(DialogBoxesActivity.this,
